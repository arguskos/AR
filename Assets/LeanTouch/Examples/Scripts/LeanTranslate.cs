	...
	public class LeanTranslate : MonoBehaviour
	{
		...
		private void Translate(Vector2 screenDelta)
		{
			...
			if (LeanTouch.GetCamera(ref Camera) == true)
			{
				...
				var screenPosition = Camera.WorldToScreenPoint(transform.position+new Vector3(0,-22,0));
                ...
                transform.Rotate(screenDelta.y,-screenDelta.x,0);//*= Quaternion.AngleAxis(screenDelta.y,new Vector3(screenDelta.x+screenDelta.y,0,0));
